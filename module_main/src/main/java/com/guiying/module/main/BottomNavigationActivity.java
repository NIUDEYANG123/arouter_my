...
public class BottomNavigationActivity extends BaseActivity {
    ...
    private void initViewPager() {
        ...
        BaseFragment fragment1 = (BaseFragment) ARouter.getInstance().build(RouterConfig.newsFragment).navigation();
        BaseFragment fragment2 = (BaseFragment) ARouter.getInstance().build(RouterConfig.girlFragment).navigation();
        //BaseFragment newsFragment = getNewsFragment();//主动寻找
        BaseFragment newsFragment = (BaseFragment) ARouter.getInstance().build(RouterConfig.girlFragmentKotlin).navigation();
